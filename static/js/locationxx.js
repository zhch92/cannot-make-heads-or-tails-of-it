...
var provinceHtml = '<div class="content"><div data-widget="tabs" class="m lh-stock" id="lh-stock">'
								+'<div class="mt">'
								+'    <ul class="tab">'
...
var areaTabContainer=$("#lh-stock .tab li");
...
(function(){
	$("#store-selector").unbind("mouseover").bind("mouseover",function(){
		...
		$("#store-selector .content,#lh-stock").show();
	}).find("dl").remove();
	CurrentAreaInfoInit();
