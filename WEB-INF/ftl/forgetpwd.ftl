    ...
    <#escape x as x?html>
        ...
        <body>
                        ...
                        <div class="table">
                            <ul id="ul1" class="next_1 next_active">
                                <li style="position:relative;">手 机<span id="art1" style=" color:red; position: absolute;top: -20px;left: 49px;display:none;">请输入正确的手机号码</span>
                                    <input id="phnenum" type="text" class="tel" maxlength="11" name="drviermoblie" value="请输入手机号" onblur="if(this.value==''){value='请输入手机号';this.style.color='#999'}else{checkPhone1()}" onfocus=" if(this.value=='请输入手机号'){this.style.color='#000';value=''}else{this.style.color='#000';select();phoneBlank()}" />
                                    <input class="msg" type="submit" id="yzm" value="发送验证码">
                                </li>
                                <li>验证码
                                    <input class="code" id="phonecode" maxlength="6" type="text" value="请输入6位短信验证码" onblur="if(this.value==''){this.style.color='#ccc';value='请输入6位短信验证码'}" onfocus="if(this.value=='请输入6位短信验证码'){this.style.color='#000';value=''}else{this.style.color='#000';select();}" />
                                    <input type="hidden" id="tempId">
                                    <input class="next" type="submit" onclick="checksteps('1');" value="下一步">
                                </li>
                            </ul>
                            <ul id="ul2" class="next_2 ">
                                ...
                                <li>确认新密码
                                    ...
                                    <input class="next" type="submit" onclick="checksteps('2');" value="下一步">
                                </li>
                            </ul>
                            <ul id="ul3" class="next_3">
                                <li>密码修改成功！请妥善保管！</li>
                                <li>
                                    <button class="next" onclick="repwdok();">完成</button>
                                </li>
                            </ul>
                        </div>
                    </div>
            ...
            <div class="footer">
              ...
              <script type="text/javascript" src="http://192.168.2.50/statics/js/forgetpwd.js"></script>
        </body>
        </html>
    </#escape>
</#compress>
