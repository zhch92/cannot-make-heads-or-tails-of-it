    ...
    <#escape x as x?html>
        ...
        <body>
            ...
            <div class="main_p">
                ...
                <div class="footer">
                    <div class="foot">
                        <p><img src="http://192.168.2.50/statics/images/logo_1.png" alt="">© 2014 HUO68.COM</p>
                    </div>
                </div>
            ...
            $("#content").append(load);
                        ...
                        if (obj.length > 0) {
                            ...
                            for (var i = 0; i < obj.length; i++) {
                                ...
                                if (orders.status == 100 && (orders.dispute == 0 || orders.dispute == 3 || orders.dispute == 4 || orders.dispute == 7)) {
                                    //取消投诉
                                    var cancelok = "<div class=\"hidden_2 hidden js_hidden_2\" id='apply2" + orders.id + "'><div class=\"hide sure_apply_1\"><p>投诉<span>交易编号：" + orders.orderNo + "</span>" + " </p><div class=\"bttn\"><button class=\"back sure\" onclick=\"checkcancelok('6','" + orders.id + "');\">交付投诉</button><button class=\"apple_a sure\" onclick=\"checkcancelok('5','" + orders.id + "');\">" + "装货投诉</button><button class=\"cancel\" onclick=\"cancelapplyyes('0','" + orders.id + "');\">返回</button></div></div></div>";
                                    //详细信息
                                    //详细地址
                                    ...
                                    cargodriverhtml += "<div class=\"details_box\" id=popdiv" + orders.cargoId + " style=\"display: none;\"><h3>查看详情 <a href=\"javascript:void(0);\" onclick=\"closebox('popdiv" + orders.cargoId + "');\"]><b></b></a></h3>" +
                                        ...
                                        "<table><tr><td class=\"titl\">" + orders.cityStr + "</td><td width=\"55\"><img src=\"http://192.168.2.50/statics/images/r1.png\" alt=\"\"></td><td width=\"80\" class=\"titl\">" + orders.arrivalCityStr + "</td></tr><tr><td>" + orders.countyStr + "</td><td></td><td>" + orders.arrivalCountyStr + "</td></tr><tr><td>" + orders.sendTimeStr + "</td><td></td><td>" + orders.arrivalTimeStr + "</td></tr></table><div class=\"text\"><p>车辆要求&nbsp&nbsp" + carlength + "&nbsp&nbsp" + cartype + "</p></div></div><div class=\"mside\">" + "<ul class=\"clearfix\"><li class=\"li_1\">接货地址:</li><li class=\"li_2\">" + orders.cityStr + orders.countyStr + orders.startAdd + "</li><li class=\"li_1\">" + "到货地址：</li><li class=\"li_2\">" + orders.arrivalCityStr + orders.arrivalCountyStr + orders.arrivalAdd + "</li></ul>" + "</div><div class=\"rside\"><p class=\"price\">RMB" + (orders.quote / 100) + "/吨</p><p class=\"introduce\">" + orders.cargoName + "/" + orders.weight + "吨/" + orders.square + "立方</p></div></div>" + "<ul><li class=\"title_b\"><table class=\"title\"><tr><td width=\"115\" style=\"padding-left:22px;\">申请时间</td><td width=\"202\">申请报价</td><td width=\"93\">车牌号" + "</td><td width=\"85\">车型</td><td width=\"102\">车长</td><td width=\"65\"></td></tr></table></li><li><table class=\"detail_item\"><tr>" + "<td width=\"115\" style=\"padding-left:22px;\">" + new Date(orders.createTime).toLocaleDateString() + "</td><td width=\"202\">" + orders.money / 100 + "元/吨×" + orders.count + "吨=<span>" + orders.total / 100 + "元</span></td>" + "<td width=\"93\">" + orders.driver.carNumber + "</td><td width=\"85\">" + cartypeset(orders.driver.carType) + "</td><td width=\"102\">" + carlengthset(orders.driver.carLength) + "</td><td width=\"65\">" + "</td></tr></table><div class=\"details clearfix\" style=\"display: block;\" id='xiangq" + orders.id + "'><dl><dd class=\"title\">联系电话: </dd>" + "<dd>司机信息:</dd></dl><dl><dd class=\"title\"><strong>" + orders.driver.mobile + "</strong></dd><dd>" + orders.driver.driverName + " <span>" + orders.driver.carNumber + "</span>" + " <span class=\"end\">" + renzheng(orders.driver.xszsfrz) + "</span></dd><dd>车型 <span>" + cartypeset(orders.driver.carType) + "</span><span>车长 </span> <span>" + carlengthset(orders.driver.carLength) + "</span></dd>" + "<dd>驾驶证 <span class=\"end\">" + renzheng(orders.driver.jszsfrz) + "</span></dd><dd>身份证 <span class=\"end\">" + renzheng(orders.driver.sfzsfrz) + "</span></dd>" + "<dd>信用 <span>拉货" + orders.driver.jhds + "笔 </span><span>装货率&nbsp" + orders.driver.zhl + "%</span> <span>交付率&nbsp" + orders.driver.jkl + "%</span></dd>" + "</dl><div class=\"bttn\"></div></div></li></ul></div>";
                                ...
                                if (orders.dispute == 1 || orders.dispute == 2 || orders.dispute == 5 || orders.dispute == 6) {
                                    ...
                                    /*    var detatousu="<div class=\"hidden_4 hidden js_hidden_4\"  id='apply1"+orders.id +"'><div class=\"hide d_adress\"><p class=\"owner\">"
                                        ...
                                        +"</p><p class=\"mar_t\">车牌号：<span>"+orders.driver.carNumber+"</span></p><button class=\"cancel js_backBtn\" onclick=\"cancelapplyno('0','"+orders.id+"');\">返回</button></div></div>";*/
                                    //取消投诉
                                    var canceltousu = "<div class=\"hidden_2 hidden js_hidden_2\"  id='apply2" + orders.id + "'><div class=\"hide sure_apply_1\"><p>投诉<span>交易编号：" + orders.orderNo + "</span> " + "</p><div class=\"bttn\"><button class=\"ing\">" + tempstatu + "</button>" + tempsbtn + "<button class=\"cancel cancel_1\" onclick=\"cancelapplyyes('0','" + orders.id + "');\" >返回</button></div></div></div>";
                                 ...
                                 var contentvar = "<p class=\"coding\">交易编号：" + orders.orderNo + statusval + "</p><div class=\"lside\"><table>" +
                                    "<tr><td class=\"titl\">" + citystr + "</td><td width=\"55\"><img src=\"http://192.168.2.50/statics/images/r1.png\" alt=\"\">" +
                                    "</td><td width=\"80\" class=\"titl\">" + arrivalcitystr + "</td></tr><tr><td>" +countrystr + "</td><td></td><td>" +arrivalcountrystr + "</td></tr><tr><td>" + orders.sendTimeStr + "</td>" +
                                    "<td></td><td>" + orders.arrivalTimeStr + "</td></tr></table><div class=\"text\"><p>车辆要求&nbsp&nbsp" + carlength + "&nbsp&nbsp" + cartype + "</p><p></p>" +
                                    "</div></div><div class=\"rside\"><p class=\"price\">RMB&nbsp" + (orders.quote / 100) + "/吨</p><p class=\"introduce\">" + orders.cargoName + "/" + orders.count + "吨/" + (((orders.square) / (orders.weight)) * (orders.count)).toFixed(0) + "立方</p><p class=\"number\"></p>" + statusbtn + "</div>" + hiddendiv;
                        ...
                        if (obj.length > 0) {
                            ...
                            for (var i = 0; i < obj.length; i++) {
                                ...
                                var contentvar = "<p class=\"coding\">货源编号：" + cargo.cargoNo + statusval + "</p><div class=\"lside\"><table>" +
                                    "<tr><td class=\"titl\">" + citystr+ "</td><td width=\"55\"><img src=\"http://192.168.2.50/statics/images/r1.png\" alt=\"\">" +
                                    "</td><td width=\"80\" class=\"titl\">" + arrivalcitystr+ "</td></tr><tr><td>" +countrystr+ "</td><td></td><td>" +arrivalcountrystr + "</td></tr><tr><td>" + cargo.sendTimeStr + "</td>" +
                                    "<td></td><td>" + cargo.arrivalTimeStr + "</td></tr></table><div class=\"text\"><p>车辆要求&nbsp&nbsp" + carlength + "&nbsp&nbsp" + cartype + "</p><p></p>" +
                                    "</div></div><div class=\"rside\"><p class=\"price\">RMB&nbsp" + (cargo.quote / 100) + "/吨</p><p class=\"introduce\">" + cargo.cargoName + "/" + cargo.weight + "吨/" + cargo.square + "立方</p>" + tempcolor1 + (cargo.ordersList).length + "申请</p>" + statusbtn + "</div>";
                                ...
                                cargodriverhtml += "<div class=\"details_box\" id=popdiv" + cargo.id + " style=\"display: none;\"><h3>查看详情 <a href=\"javascript:void(0);\" onclick=\"closebox('popdiv" + cargo.id + "');\"]><b></b></a></h3>" +
                                    ...
                                    "<table><tr><td class=\"titl\">" + cargo.cityStr + "</td><td width=\"55\"><img src=\"http://192.168.2.50/statics/images/r1.png\" alt=\"\"></td><td width=\"80\" class=\"titl\">" + cargo.arrivalCityStr + "</td></tr><tr><td>" + cargo.countyStr + "</td><td></td><td>" + cargo.arrivalCountyStr + "</td></tr><tr><td>" + cargo.sendTimeStr + "</td><td></td><td>" + cargo.arrivalTimeStr + "</td></tr></table><div class=\"text\"><p>车辆要求&nbsp&nbsp" + carlength + "&nbsp&nbsp" + cartype + "</p></div></div><div class=\"mside\">" + "<ul class=\"clearfix\"><li class=\"li_1\">接货地址：" + "</li><li class=\"li_2\">" + cargo.cityStr + cargo.countyStr + cargo.startAdd + "</li><li class=\"li_1\">" + "到货地址：</li><li class=\"li_2\">" + cargo.arrivalCityStr + cargo.arrivalCountyStr + cargo.arrivalAdd + "</li></ul>" + "</div><div class=\"rside\"><p class=\"price\">RMB" + (cargo.quote / 100) + "/吨</p><p class=\"introduce\">" + cargo.cargoName + "/" + cargo.weight + "吨/" + cargo.square + "立方</p>" + tempcolor + (cargo.ordersList).length + "人申请</p></div></div>" + "<ul><li class=\"title_b\"><table class=\"title\"><tr>" + "<td width=\"115\" style=\"padding-left:22px;\">申请时间</td><td width=\"202\">申请报价</td><td width=\"93\">车牌号" + "</td><td width=\"85\">车型</td><td width=\"102\">车长</td><td width=\"65\"></td></tr></table></li>";
                                for (var j = 0; j < (cargo.ordersList).length; j++) {
                                    ...
                                    cargodriverhtml += "<li><table class=\"detail_item\"><tr>" + "<td width=\"115\" style=\"padding-left:22px;\">" + new Date(orders.createTime).toLocaleDateString() + "</td><td width=\"202\">" + orders.money / 100 + "元/吨×" + orders.count + "吨=<span>" + orders.total / 100 + "元</span></td>" + "<td width=\"93\">" + orders.driver.carNumber + "</td><td width=\"85\">" + cartypeset(orders.driver.carType) + "</td><td width=\"102\">" + carlengthset(orders.driver.carLength) + "</td><td width=\"70\"><a href=\"javascript:void(0);\" onclick=\"xiangqing('xiangq" + orders.id + "');\" ><span class=\"togg\">" + "<i id=\"arrowI\"></i>查看详情</span></a></td>" + "</tr></table><div class=\"details clearfix\" id='xiangq" + orders.id + "'><dl><dd class=\"title\">联系电话: </dd>" + "<dd>司机信息:</dd></dl><dl><dd class=\"title\"><strong>" + orders.driver.mobile + "</strong></dd><dd>" + orders.driver.driverName + " <span>" + orders.driver.carNumber + "</span>" + " <span class=\"end\">" + renzheng(orders.driver.xszsfrz) + "</span></dd><dd>车型 <span>" + cartypeset(orders.driver.carType) + "</span><span>车长 </span> <span>" + carlengthset(orders.driver.carLength) + "</span></dd>" + "<dd>驾驶证 <span class=\"end\">" + renzheng(orders.driver.jszsfrz) + "</span></dd><dd>身份证 <span class=\"end\">" + renzheng(orders.driver.sfzsfrz) + "</span></dd>" + "<dd>信用 <span>拉货" + orders.driver.jhds + "笔 </span><span>装货率&nbsp" + orders.driver.zhl + "%</span> <span>交付率&nbsp" + orders.driver.jkl + "%</span></dd>" + "</dl><div class=\"bttn\"><button class=\"confirm\" onclick=\"agreeApply(this,'popdiv" + cargo.id + "','" + orders.id + "');\">同意</button>" + "<button class=\"cel\" onclick=\"xiangqing('xiangq" + orders.id + "');\"  >返回</button></div></div></li>";
                                }
                                var tempno = "";
                                if ((cargo.ordersList).length <= 0) {
                ...
                function xiangqing(val) {
                    $("#" + val + "").toggle();
                    if (temparrowI == 0) {
                        $("#arrowI").css("background", 'url(http://192.168.2.50/statics/images/look.png) no-repeat 0px 0px');
                        temparrowI = 1;
                    } else {
                        $("#arrowI").css("background", 'url(http://192.168.2.50/statics/images/look.png) no-repeat -7px 0px');
                        temparrowI = 0;
                    }
