...
<head>
    ...
    <title>货管家-唯有可靠-门店</title>
     <link rel="stylesheet" href="http://192.168.2.50/staticstop/css/reset.css">
    <link rel="stylesheet" href="http://192.168.2.50/staticstop/css/style.css">
    <script type="text/javascript" src="http://192.168.2.50/staticstop/js/jquery.js"></script>
...
<body>
    <div class="header">
        <div class="head clearfix">
            <div class="logo"><img src="http://192.168.2.50/staticstop/images/logo.png" alt=""></div>
            <div class="code">
                把可靠货源装进口袋
            </div>
        </div>
               ...
               <div class="floor clearfix">
                ...
                <div class="item clearfix">
                        <div class="lside">
                            <table>
                                <tr class="tr_1">
                                    <td width="80"><span>${cargo.cityStr}</span> </td>
                                    <td width="60"><img src="http://192.168.2.50/staticstop/images/r.png" alt=""></td>
                                    <td width="80"><span>${cargo.arrivalCityStr}</span> </td>
                                </tr>
                                <tr class="tr_2">
                                    <td>${cargo.countyStr}</td>
                                    <td></td>
    ...
    $(document).ready(function() {
        ...
        setInterval("personBusi()",1000*4);
    });
    function personBusi(){
    	 $.ajax({
             type: "POST",
             url: "/ajax/newCargoStatus.htm",
             datatype:"json",
             success: function(msg)
             {
            	 var obj=eval('('+msg+')'); 
                 if(obj.flag==1){
                	 window.location.href="/s.htm";
                 }
             }
             });
    }
