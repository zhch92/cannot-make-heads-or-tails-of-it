...
<title>货管家大屏幕</title>
<link href="http://192.168.2.50/static/led/css/style.css" rel="stylesheet" media="screen" type="text/css">
<script type="text/javascript"  src="http://192.168.2.50/static/led/js/jquery-1.7.2.min.js"></script>
<script type="text/javascript"  src="http://192.168.2.50/static/led/js/jquery_public.js"></script>
<script type="text/javascript" src="http://192.168.2.50/static/led/js/jquery.qrcode.min.js"></script>
</head>
<body class="hidden">
...
<table class="content">
	...
	<#if cargos?? >
        ...
        <#else>
        	<h3>暂无货源</h3>
        	<#--
        	<div style="padding-left:10px;" id="outputqrcodeApk" cargoid="http://192.168.2.50/hgjapk/apk/lahuo8.apk"></div>
        	<br/>
