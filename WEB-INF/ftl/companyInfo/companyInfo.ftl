...
<head>
    ...
    <link rel="stylesheet" href="http://192.168.2.50:8080/statics/css/info.css">
      <script type="text/javascript" src="http://192.168.2.50:8080/statics/js/jquery.js"></script>
           <script type="text/javascript" src="http://192.168.2.50:8080/static/js/jquery.form.js"></script>
           <script>
var _hmt = _hmt || [];
(function() {
...
<#include "common/head.ftl"/>
    <div class="content">
        <div class="logo">
             <a href="/index.htm"> <img src="http://192.168.2.50:8080/statics/images/logo.png" alt=""></a>
        </div> 
        <div class="main">
            <h3>设置</h3>
            ...
            <div class="info">
                <div class="basic_set">
                  <p>企业名称<input class="name" disabled="disabled" type="text" value="${allCompanyInfo.companyInfo.companyName}">手机<input class="tel" disabled="disabled" type="text" value="13587896542"></p> 
                        ...
                        <form id="yyzzImgImgform"  action="/ajax/uploadYyzzImg.htm"  method="post" enctype="multipart/form-data" >
                            <#if allCompanyInfo.companyInfo.yyzzsfrz?? && allCompanyInfo.companyInfo.yyzzsfrz !=""&& allCompanyInfo.companyInfo.yyzzsfrz !="0">
													<#if allCompanyInfo.companyInfo.yyzzsfrz == 10>
														  ...
														  <p class="img"><img src="http://192.168.2.50:8080/statics/images/papers_6.png" alt=""></p>
														     <p> 营业执照副本</p>
						 ...
						 <div class="loading" id="yyzzloading"><img alt="" src="http://192.168.2.50:8080/statics/images/loading.gif"></div>
                        </li>
                    </ul>
                    <p class="bttn">
